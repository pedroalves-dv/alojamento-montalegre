...
export default async function PropertyBookingCTA({ property, locale }: Props) {
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-white text-forest px-8 py-4 rounded-lg font-semibold text-base hover:bg-fog transition-colors"
          >
            <WhatsAppIcon />
            {t("bookingWhatsapp")}
          </a>
          {property.booking.url && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center border-2 border-white/50 text-white px-8 py-4 rounded-lg font-semibold text-base hover:bg-white/10 transition-colors"
            >
              {t("bookingBookingCom")}
            </a>
          )}
