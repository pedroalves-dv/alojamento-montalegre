    ...
    <section className="relative min-h-[calc(100svh-var(--navbar-height))] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-6xl px-4 ">
        ...
        >
          ...
          <Link
            href={`/${locale}/regiao`}
            className="bg-fog/10 hover:bg-granite/60 border border-fog/60 text-white px-8 py-3.5 rounded-lg font-medium tracking-wide transition-colors duration-200 drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]"
          >
            {t("ctaConhecerRegiao")}
          </Link>
        </motion.div>
